...
void Damier::Retour_en_arriere()
{
    ...
    Il faut donc créer une fonction pour copier 2 tableaux */
    Copier_deux_tableaux(dam, dam_precedent);
}

/* Méthode qui permet de copier deux tableaux */
...
{
    /* Déjà, si le joueur décide de revenir en arrière: */
    if (mouvement_execute == 4){
        Retour_en_arriere();
    } else {
